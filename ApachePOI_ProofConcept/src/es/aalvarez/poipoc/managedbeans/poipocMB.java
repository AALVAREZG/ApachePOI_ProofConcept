package es.aalvarez.poipoc.managedbeans;
...
import es.aalvarez.poipoc.poi.GeneraArchivoWord;
...
public class poipocMB implements Serializable {
	...
	public void generarArchivo(){
		...
		try {
			...
			rutaDocumento = docx.replaceTextFound(realPath, this.id, this.nombre, this.texto);
